...
export const PageVisitsTable = forwardRef((props, ref) => {
...
export const PageTrafficTable = forwardRef((props, ref) => {
        const TableRow = (props) => {
        ...
        return (
            <Card border="light" className="shadow-sm mb-4" ref={ref}>
...
export const RankingTable = forwardRef((props, ref) => {
        const TableRow = (props) => {
            const {
                country,
                countryImage,
...
export const TransactionsTable = forwardRef((props, ref) => {
        ...
        return (
            <Card border="light" className="table-wrapper table-responsive shadow-sm" ref={ref}>
