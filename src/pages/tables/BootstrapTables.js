...
import {pageTrafficTable, rankingTable} from "../../interactive guide/Guides";
...
export default () => {
    ...
    return (
        <>
            ...
            <PageTrafficTable ref={(ref) => setInteractiveGuide(ref, pageTrafficTable)}/>
            <RankingTable ref={(ref) => setInteractiveGuide(ref, rankingTable)}/>
        </>
    );
};
