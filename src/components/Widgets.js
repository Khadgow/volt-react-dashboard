...
export const CounterWidget = forwardRef((props, ref) => {
      const {icon, iconColor, category, title, period, percentage} = props;
      const percentageIcon = percentage < 0 ? faAngleDown : faAngleUp;
      const percentageColor = percentage < 0 ? "text-danger" : "text-success";

      return (
          <Card border="light" className="shadow-sm" ref={ref}>
            <Card.Body>
...
export const CircleChartWidget = forwardRef((props, ref) => {
...
export const BarChartWidget = forwardRef((props, ref) => {
...
export const TeamMembersWidget = forwardRef((props, ref) => {
...
export const ProgressTrackWidget = forwardRef((props, ref) => {
...
export const RankingWidget = forwardRef((props, ref) => {
      return (
          <Card border="light" className="shadow-sm" ref={ref}>
            <Card.Body>
              ...
              <div className="d-flex align-items-center justify-content-between pt-3">
                <div>
                  <h6 className="mb-0"><FontAwesomeIcon icon={faFolderOpen} className="icon icon-xs me-3"/>Category Rank
                  </h6>
...
export const SalesValueWidget = forwardRef((props, ref) => {
      const {title, value, percentage} = props;
      const percentageIcon = percentage < 0 ? faAngleDown : faAngleUp;
      const percentageColor = percentage < 0 ? "text-danger" : "text-success";

      return (
          <Card ref={ref} className="bg-secondary-alt shadow-sm">
...
export const AcquisitionWidget = forwardRef((props, ref) => {
      return (
          <Card border="light" className="shadow-sm" ref={ref}>
            <Card.Body>
              <h5>Acquisition</h5>
